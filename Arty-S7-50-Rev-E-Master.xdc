...
## NOTE: These constraints should be used when using the analog header signals A20-A25 as digital I/O (Chipkit digital pins 20-25)
## NOTE: Do not use these constraints with the vaux(3/8)(p/n) constraints below, as they constrain the same pins
...
## NOTE: These constraints should be used when using the analog header signals A20-A25 as analog inputs (Chipkit digital pins 20-25)
