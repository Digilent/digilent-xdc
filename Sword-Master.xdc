...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN D24   IOSTANDARD LVDS     } [get_ports { ja_n[1] }]; #IO_L4N_T0_16 Sch=ja_n[1]
#set_property -dict { PACKAGE_PIN E24   IOSTANDARD LVDS     } [get_ports { ja_p[1] }]; #IO_L4P_T0_16 Sch=ja_p[1]
#set_property -dict { PACKAGE_PIN G24   IOSTANDARD LVDS     } [get_ports { ja_n[2] }]; #IO_L6N_T0_VREF_16 Sch=ja_n[2]
#set_property -dict { PACKAGE_PIN G23   IOSTANDARD LVDS     } [get_ports { ja_p[2] }]; #IO_L6P_T0_16 Sch=ja_p[2]
#set_property -dict { PACKAGE_PIN E26   IOSTANDARD LVDS     } [get_ports { ja_n[3] }]; #IO_L5N_T0_16 Sch=ja_n[3]
#set_property -dict { PACKAGE_PIN F26   IOSTANDARD LVDS     } [get_ports { ja_p[3] }]; #IO_L5P_T0_16 Sch=ja_p[3]
#set_property -dict { PACKAGE_PIN A27   IOSTANDARD LVDS     } [get_ports { ja_n[4] }]; #IO_L7N_T1_16 Sch=ja_n[4]
#set_property -dict { PACKAGE_PIN B27   IOSTANDARD LVDS     } [get_ports { ja_p[4] }]; #IO_L7P_T1_16 Sch=ja_p[4]

## Pmod Header JB
#set_property -dict { PACKAGE_PIN A28   IOSTANDARD LVDS     } [get_ports { jb_n[1] }]; #IO_L9N_T1_DQS_16 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN B28   IOSTANDARD LVDS     } [get_ports { jb_p[1] }]; #IO_L9P_T1_DQS_16 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN A26   IOSTANDARD LVDS     } [get_ports { jb_n[2] }]; #IO_L10N_T1_16 Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN A25   IOSTANDARD LVDS     } [get_ports { jb_p[2] }]; #IO_L10P_T1_16 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN C26   IOSTANDARD LVDS     } [get_ports { jb_n[3] }]; #IO_L11N_T1_SRCC_16 Sch=jb_n[3]
#set_property -dict { PACKAGE_PIN D26   IOSTANDARD LVDS     } [get_ports { jb_p[3] }]; #IO_L11P_T1_SRCC_16 Sch=jb_p[3]
#set_property -dict { PACKAGE_PIN B25   IOSTANDARD LVDS     } [get_ports { jb_n[4] }]; #IO_L12N_T1_MRCC_16 Sch=jb_n[4]
#set_property -dict { PACKAGE_PIN C25   IOSTANDARD LVDS     } [get_ports { jb_p[4] }]; #IO_L12P_T1_MRCC_16 Sch=jb_p[4]

## Pmod Header JC
#set_property -dict { PACKAGE_PIN E28   IOSTANDARD LVCMOS33 } [get_ports { jc[1] }]; #IO_L14P_T2_SRCC_16 Sch=jc[1]
#set_property -dict { PACKAGE_PIN D28   IOSTANDARD LVCMOS33 } [get_ports { jc[2] }]; #IO_L14N_T2_SRCC_16 Sch=jc[2]
#set_property -dict { PACKAGE_PIN C29   IOSTANDARD LVCMOS33 } [get_ports { jc[3] }]; #IO_L15P_T2_DQS_16 Sch=jc[3]
#set_property -dict { PACKAGE_PIN B29   IOSTANDARD LVCMOS33 } [get_ports { jc[4] }]; #IO_L15N_T2_DQS_16 Sch=jc[4]
#set_property -dict { PACKAGE_PIN D29   IOSTANDARD LVCMOS33 } [get_ports { jc[7] }]; #IO_L16P_T2_16 Sch=jc[7]
#set_property -dict { PACKAGE_PIN C30   IOSTANDARD LVCMOS33 } [get_ports { jc[8] }]; #IO_L16N_T2_16 Sch=jc[8]
#set_property -dict { PACKAGE_PIN B30   IOSTANDARD LVCMOS33 } [get_ports { jc[9] }]; #IO_L17P_T2_16 Sch=jc[9]
#set_property -dict { PACKAGE_PIN A30   IOSTANDARD LVCMOS33 } [get_ports { jc[10] }]; #IO_L17N_T2_16 Sch=jc[10]

## Pmod Header JD
#set_property -dict { PACKAGE_PIN E29   IOSTANDARD LVCMOS33 } [get_ports { jd[1] }]; #IO_L18P_T2_16 Sch=jd[1]
#set_property -dict { PACKAGE_PIN E30   IOSTANDARD LVCMOS33 } [get_ports { jd[2] }]; #IO_L18N_T2_16 Sch=jd[2]
#set_property -dict { PACKAGE_PIN H24   IOSTANDARD LVCMOS33 } [get_ports { jd[3] }]; #IO_L19P_T3_16 Sch=jd[3]
#set_property -dict { PACKAGE_PIN H25   IOSTANDARD LVCMOS33 } [get_ports { jd[4] }]; #IO_L19N_T3_VREF_16 Sch=jd[4]
#set_property -dict { PACKAGE_PIN G28   IOSTANDARD LVCMOS33 } [get_ports { jd[7] }]; #IO_L20P_T3_16 Sch=jd[7]
#set_property -dict { PACKAGE_PIN F28   IOSTANDARD LVCMOS33 } [get_ports { jd[8] }]; #IO_L20N_T3_16 Sch=jd[8]
#set_property -dict { PACKAGE_PIN G27   IOSTANDARD LVCMOS33 } [get_ports { jd[9] }]; #IO_L21P_T3_DQS_16 Sch=jd[9]
#set_property -dict { PACKAGE_PIN F27   IOSTANDARD LVCMOS33 } [get_ports { jd[10] }]; #IO_L21N_T3_DQS_16 Sch=jd[10]

## USB-UART Interface
#set_property -dict { PACKAGE_PIN F30   IOSTANDARD LVCMOS33 } [get_ports { uart_rxd_out }]; #IO_L22N_T3_16 Sch=uart_rxd_out
#set_property -dict { PACKAGE_PIN G29   IOSTANDARD LVCMOS33 } [get_ports { uart_txd_in }]; #IO_L22P_T3_16 Sch=uart_txd_in
...
#set_property -dict { PACKAGE_PIN AE24  IOSTANDARD LVCMOS33 } [get_ports { ps2_clk[1] }]; #IO_L12N_T1_MRCC_12 Sch=ps2_clk[1]
#set_property -dict { PACKAGE_PIN AF22  IOSTANDARD LVCMOS33 } [get_ports { ps2_data[1] }]; #IO_L13P_T2_MRCC_12 Sch=ps2_data[1]
...
##       These signals should only be connected to the XADC core. When using these pins as digital I/O, use ports ck_io[14-19]
#set_property -dict { PACKAGE_PIN J29   IOSTANDARD LVDS     } [get_ports { vaux10_p }]; #IO_L7P_T1_AD10P_15 Sch=ck_an_p[0]
#set_property -dict { PACKAGE_PIN H29   IOSTANDARD LVDS     } [get_ports { vaux10_n }]; #IO_L7N_T1_AD10N_15 Sch=ck_an_n[0]
#set_property -dict { PACKAGE_PIN L22   IOSTANDARD LVDS     } [get_ports { vaux8_p }]; #IO_L2P_T0_AD8P_15 Sch=ck_an_p[1]
#set_property -dict { PACKAGE_PIN L23   IOSTANDARD LVDS     } [get_ports { vaux8_n }]; #IO_L2N_T0_AD8N_15 Sch=ck_an_n[1]
#set_property -dict { PACKAGE_PIN J23   IOSTANDARD LVDS     } [get_ports { vaux0_p }]; #IO_L1P_T0_AD0P_15 Sch=ck_an_p[2]
#set_property -dict { PACKAGE_PIN J24   IOSTANDARD LVDS     } [get_ports { vaux0_n }]; #IO_L1N_T0_AD0N_15 Sch=ck_an_n[2]
#set_property -dict { PACKAGE_PIN K23   IOSTANDARD LVDS     } [get_ports { vaux1_p }]; #IO_L3P_T0_DQS_AD1P_15 Sch=ck_an_p[3]
#set_property -dict { PACKAGE_PIN K24   IOSTANDARD LVDS     } [get_ports { vaux1_n }]; #IO_L3N_T0_DQS_AD1N_15 Sch=ck_an_n[3]
#set_property -dict { PACKAGE_PIN L21   IOSTANDARD LVDS     } [get_ports { vaux9_p }]; #IO_L4P_T0_AD9P_15 Sch=ck_an_p[4]
#set_property -dict { PACKAGE_PIN K21   IOSTANDARD LVDS     } [get_ports { vaux9_n }]; #IO_L4N_T0_AD9N_15 Sch=ck_an_n[4]
#set_property -dict { PACKAGE_PIN J21   IOSTANDARD LVDS     } [get_ports { vaux2_p }]; #IO_L5P_T0_AD2P_15 Sch=ck_an_p[5]
#set_property -dict { PACKAGE_PIN J22   IOSTANDARD LVDS     } [get_ports { vaux2_n }]; #IO_L5N_T0_AD2N_15 Sch=ck_an_n[5]

## ChipKit Differential Analog Inputs
## NOTE: The fpga_ad pins can be used as differential analog inputs with voltages from 0-1.0V (ChipKit Analog pins A6-A11)
##       These constraints should be used with the XADC core.When using these pins as digital I/O, use ports ck_io[20-25]
#set_property -dict { PACKAGE_PIN J27   IOSTANDARD LVDS     } [get_ports { vaux3_p }]; #IO_L8P_T1_AD3P_15 Sch=fpga_ad_p[3]
#set_property -dict { PACKAGE_PIN J28   IOSTANDARD LVDS     } [get_ports { vaux3_n }]; #IO_L8N_T1_AD3N_15 Sch=fpga_ad_n[3]
#set_property -dict { PACKAGE_PIN L30   IOSTANDARD LVDS     } [get_ports { vaux11_p }]; #IO_L9P_T1_DQS_AD11P_15 Sch=fpga_ad_p[11]
#set_property -dict { PACKAGE_PIN K30   IOSTANDARD LVDS     } [get_ports { vaux11_n }]; #IO_L9N_T1_DQS_AD11N_15 Sch=fpga_ad_n[11]
#set_property -dict { PACKAGE_PIN K26   IOSTANDARD LVDS     } [get_ports { vaux4_p }]; #IO_L10P_T1_AD4P_15 Sch=fpga_ad_p[4]
#set_property -dict { PACKAGE_PIN J26   IOSTANDARD LVDS     } [get_ports { vaux4_n }]; #IO_L10N_T1_AD4N_15 Sch=fpga_ad_n[4]
...
#set_property -dict { PACKAGE_PIN N22   IOSTANDARD LVCMOS33 } [get_ports { ck_io[0]  }]; #IO_L20N_T3_A19_15 Sch=ck_io[0]
#set_property -dict { PACKAGE_PIN N25   IOSTANDARD LVCMOS33 } [get_ports { ck_io[1]  }]; #IO_L18P_T2_A24_15 Sch=ck_io[1]
#set_property -dict { PACKAGE_PIN P22   IOSTANDARD LVCMOS33 } [get_ports { ck_io[2]  }]; #IO_L22N_T3_A16_15 Sch=ck_io[2]
#set_property -dict { PACKAGE_PIN G25   IOSTANDARD LVCMOS33 } [get_ports { ck_io[3]  }]; #IO_25_16 Sch=ck_io[3]
#set_property -dict { PACKAGE_PIN L25   IOSTANDARD LVCMOS33 } [get_ports { ck_io[4]  }]; #IO_L12P_T1_MRCC_AD5P_15 Sch=ck_io[4]
#set_property -dict { PACKAGE_PIN M25   IOSTANDARD LVCMOS33 } [get_ports { ck_io[5]  }]; #IO_L23N_T3_FWE_B_15 Sch=ck_io[5]
#set_property -dict { PACKAGE_PIN L26   IOSTANDARD LVCMOS33 } [get_ports { ck_io[6]  }]; #IO_L11P_T1_SRCC_AD12P_15 Sch=ck_io[6]
#set_property -dict { PACKAGE_PIN K29   IOSTANDARD LVCMOS33 } [get_ports { ck_io[7]  }]; #IO_L13N_T2_MRCC_15 Sch=ck_io[7]
#set_property -dict { PACKAGE_PIN M29   IOSTANDARD LVCMOS33 } [get_ports { ck_io[8]  }]; #IO_L15P_T2_DQS_15 Sch=ck_io[8]
#set_property -dict { PACKAGE_PIN M30   IOSTANDARD LVCMOS33 } [get_ports { ck_io[9]  }]; #IO_L15N_T2_DQS_ADV_B_15 Sch=ck_io[9]
#set_property -dict { PACKAGE_PIN L28   IOSTANDARD LVCMOS33 } [get_ports { ck_io[10] }]; #IO_L14N_T2_SRCC_15 Sch=ck_io10_ss
#set_property -dict { PACKAGE_PIN M27   IOSTANDARD LVCMOS33 } [get_ports { ck_io[11] }]; #IO_L16N_T2_A27_15 Sch=ck_io11_mosi
#set_property -dict { PACKAGE_PIN N29   IOSTANDARD LVCMOS33 } [get_ports { ck_io[12] }]; #IO_L17P_T2_A26_15 Sch=ck_io12_miso
#set_property -dict { PACKAGE_PIN N30   IOSTANDARD LVCMOS33 } [get_ports { ck_io[13] }]; #IO_L17N_T2_A25_15 Sch=ck_io13_sck

## ChipKit Digital I/O On Outer Analog Header
## NOTE: These constraints should be used when using the analog header signals A0-A5 as digital I/O (Chipkit digital pins 14-19)
#set_property -dict { PACKAGE_PIN B23   IOSTANDARD LVCMOS33 } [get_ports { ck_io[14] }]; #IO_L1P_T0_16 Sch=ck_a[0]
#set_property -dict { PACKAGE_PIN A23   IOSTANDARD LVCMOS33 } [get_ports { ck_io[15] }]; #IO_L1N_T0_16 Sch=ck_a[1]
#set_property -dict { PACKAGE_PIN E23   IOSTANDARD LVCMOS33 } [get_ports { ck_io[16] }]; #IO_L2P_T0_16 Sch=ck_a[2]
#set_property -dict { PACKAGE_PIN D23   IOSTANDARD LVCMOS33 } [get_ports { ck_io[17] }]; #IO_L2N_T0_16 Sch=ck_a[3]
#set_property -dict { PACKAGE_PIN F25   IOSTANDARD LVCMOS33 } [get_ports { ck_io[18] }]; #IO_L3P_T0_DQS_16 Sch=ck_a[4]
#set_property -dict { PACKAGE_PIN E25   IOSTANDARD LVCMOS33 } [get_ports { ck_io[19] }]; #IO_L3N_T0_DQS_16 Sch=ck_a[5]

## ChipKit Digital I/O on Inner Analog Header
## NOTE: These constraints should be used when using the analog header signals A6-A11 as digital I/O (Chipkit digital pins 20-25)
#set_property -dict { PACKAGE_PIN J28   IOSTANDARD LVDS     } [get_ports { ck_io[20] }]; #IO_L8N_T1_AD3N_15 Sch=fpga_ad_n[3]
#set_property -dict { PACKAGE_PIN J27   IOSTANDARD LVDS     } [get_ports { ck_io[21] }]; #IO_L8P_T1_AD3P_15 Sch=fpga_ad_p[3]
#set_property -dict { PACKAGE_PIN K30   IOSTANDARD LVDS     } [get_ports { ck_io[22] }]; #IO_L9N_T1_DQS_AD11N_15 Sch=fpga_ad_n[11]
#set_property -dict { PACKAGE_PIN L30   IOSTANDARD LVDS     } [get_ports { ck_io[23] }]; #IO_L9P_T1_DQS_AD11P_15 Sch=fpga_ad_p[11]
#set_property -dict { PACKAGE_PIN J26   IOSTANDARD LVDS     } [get_ports { ck_io[24] }]; #IO_L10N_T1_AD4N_15 Sch=fpga_ad_n[4]
#set_property -dict { PACKAGE_PIN K26   IOSTANDARD LVDS     } [get_ports { ck_io[25] }]; #IO_L10P_T1_AD4P_15 Sch=fpga_ad_p[4]

## ChipKit Digital I/O High
#set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { ck_io[26] }]; #IO_L6P_T0_15 Sch=ck_io[26]
#set_property -dict { PACKAGE_PIN N24   IOSTANDARD LVCMOS33 } [get_ports { ck_io[27] }]; #IO_L21N_T3_DQS_A18_15 Sch=ck_io[27]
#set_property -dict { PACKAGE_PIN P23   IOSTANDARD LVCMOS33 } [get_ports { ck_io[28] }]; #IO_L21P_T3_DQS_15 Sch=ck_io[28]
#set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { ck_io[29] }]; #IO_0_15 Sch=ck_io[29]
#set_property -dict { PACKAGE_PIN P21   IOSTANDARD LVCMOS33 } [get_ports { ck_io[30] }]; #IO_L22P_T3_A17_15 Sch=ck_io[30]
#set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS33 } [get_ports { ck_io[31] }]; #IO_L19N_T3_A21_VREF_15 Sch=ck_io[31]
#set_property -dict { PACKAGE_PIN F23   IOSTANDARD LVCMOS33 } [get_ports { ck_io[32] }]; #IO_0_16 Sch=ck_io[32]
#set_property -dict { PACKAGE_PIN K28   IOSTANDARD LVCMOS33 } [get_ports { ck_io[33] }]; #IO_L13P_T2_MRCC_15 Sch=ck_io[33]
#set_property -dict { PACKAGE_PIN L27   IOSTANDARD LVCMOS33 } [get_ports { ck_io[34] }]; #IO_L11N_T1_SRCC_AD12N_15 Sch=ck_io[34]
#set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS33 } [get_ports { ck_io[35] }]; #IO_L19P_T3_A22_15 Sch=ck_io[35]
#set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33 } [get_ports { ck_io[36] }]; #IO_25_15 Sch=ck_io[36]
#set_property -dict { PACKAGE_PIN M28   IOSTANDARD LVCMOS33 } [get_ports { ck_io[37] }]; #IO_L14P_T2_SRCC_15 Sch=ck_io[37]
#set_property -dict { PACKAGE_PIN M22   IOSTANDARD LVCMOS33 } [get_ports { ck_io[38] }]; #IO_L24P_T3_RS1_15 Sch=ck_io[38]
#set_property -dict { PACKAGE_PIN M23   IOSTANDARD LVCMOS33 } [get_ports { ck_io[39] }]; #IO_L24N_T3_RS0_15 Sch=ck_io[39]
#set_property -dict { PACKAGE_PIN N27   IOSTANDARD LVCMOS33 } [get_ports { ck_io[40] }]; #IO_L16P_T2_A28_15 Sch=ck_io[40]
#set_property -dict { PACKAGE_PIN N26   IOSTANDARD LVCMOS33 } [get_ports { ck_io[41] }]; #IO_L18N_T2_A23_15 Sch=ck_io[41]
...
## RS232 Connector
#set_property -dict { PACKAGE_PIN D11   IOSTANDARD LVCMOS33 } [get_ports { uart1_rxd }]; #IO_L18P_T2_18 Sch=uart1_rxd
#set_property -dict { PACKAGE_PIN G12   IOSTANDARD LVCMOS33 } [get_ports { uart1_txd }]; #IO_0_18 Sch=uart1_txd

# 3-Pin UART Connector
#set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { uart2_rxd }]; #IO_L18N_T2_18 Sch=uart2_rxd
#set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { uart2_txd }]; #IO_25_18 Sch=uart2_txd

## VGA Connector
#set_property -dict { PACKAGE_PIN AA23  IOSTANDARD LVCMOS33 } [get_ports { vga_b[3] }]; #IO_L4N_T0_12 Sch=vga_b[3]
#set_property -dict { PACKAGE_PIN AC24  IOSTANDARD LVCMOS33 } [get_ports { vga_b[4] }]; #IO_L9P_T1_DQS_12 Sch=vga_b[4]
#set_property -dict { PACKAGE_PIN AD24  IOSTANDARD LVCMOS33 } [get_ports { vga_b[5] }]; #IO_L9N_T1_DQS_12 Sch=vga_b[5]
#set_property -dict { PACKAGE_PIN AB23  IOSTANDARD LVCMOS33 } [get_ports { vga_b[6] }]; #IO_L3N_T0_DQS_12 Sch=vga_b[6]
#set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { vga_b[7] }]; #IO_L3P_T0_DQS_12 Sch=vga_b[7]
#set_property -dict { PACKAGE_PIN AA22  IOSTANDARD LVCMOS33 } [get_ports { vga_g[2] }]; #IO_L4P_T0_12 Sch=vga_g[2]
#set_property -dict { PACKAGE_PIN AC21  IOSTANDARD LVCMOS33 } [get_ports { vga_g[3] }]; #IO_L5N_T0_12 Sch=vga_g[3]
#set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { vga_g[4] }]; #IO_L2P_T0_12 Sch=vga_g[4]
#set_property -dict { PACKAGE_PIN AC20  IOSTANDARD LVCMOS33 } [get_ports { vga_g[5] }]; #IO_L5P_T0_12 Sch=vga_g[5]
#set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { vga_g[6] }]; #IO_L6N_T0_VREF_12 Sch=vga_g[6]
#set_property -dict { PACKAGE_PIN AA20  IOSTANDARD LVCMOS33 } [get_ports { vga_g[7] }]; #IO_L6P_T0_12 Sch=vga_g[7]
#set_property -dict { PACKAGE_PIN AC25  IOSTANDARD LVCMOS33 } [get_ports { vga_r[3] }]; #IO_L7N_T1_12 Sch=vga_r[3]
#set_property -dict { PACKAGE_PIN AB24  IOSTANDARD LVCMOS33 } [get_ports { vga_r[4] }]; #IO_L7P_T1_12 Sch=vga_r[4]
#set_property -dict { PACKAGE_PIN Y24   IOSTANDARD LVCMOS33 } [get_ports { vga_r[5] }]; #IO_L1N_T0_12 Sch=vga_r[5]
#set_property -dict { PACKAGE_PIN Y23   IOSTANDARD LVCMOS33 } [get_ports { vga_r[6] }]; #IO_L1P_T0_12 Sch=vga_r[6]
#set_property -dict { PACKAGE_PIN AD22  IOSTANDARD LVCMOS33 } [get_ports { vga_r[7] }]; #IO_L8N_T1_12 Sch=vga_r[7]
...
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { flash_ce[1] }]; #IO_L18P_T2_17 Sch=flash_ce[1]
#set_property -dict { PACKAGE_PIN D16   IOSTANDARD LVCMOS33 } [get_ports { flash_ce[2] }]; #IO_L15P_T2_DQS_17 Sch=flash_ce[2]
...
#set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { flash_ryby[1] }]; #IO_L16P_T2_17 Sch=flash_ryby[1]
#set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { flash_ryby[2] }]; #IO_L24N_T3_17 Sch=flash_ryby[2]
...
#set_property -dict { PACKAGE_PIN AB28  IOSTANDARD LVCMOS33 } [get_ports { sram2_bhe[1] }]; #IO_L5N_T0_13 Sch=sram2-bhe[1]
#set_property -dict { PACKAGE_PIN V26   IOSTANDARD LVCMOS33 } [get_ports { sram2_bhe[2] }]; #IO_L16P_T2_CSI_B_14 Sch=sram2-bhe[2]
#set_property -dict { PACKAGE_PIN AC26  IOSTANDARD LVCMOS33 } [get_ports { sram2_ble[1] }]; #IO_L19P_T3_13 Sch=sram2-ble[1]
#set_property -dict { PACKAGE_PIN W27   IOSTANDARD LVCMOS33 } [get_ports { sram2_ble[2] }]; #IO_L2P_T0_13 Sch=sram2-ble[2]
#set_property -dict { PACKAGE_PIN Y28   IOSTANDARD LVCMOS33 } [get_ports { sram2_ce[1] }]; #IO_L3P_T0_DQS_13 Sch=sram2-ce[1]
#set_property -dict { PACKAGE_PIN P28   IOSTANDARD LVCMOS33 } [get_ports { sram2_ce[2] }]; #IO_L8N_T1_D12_14 Sch=sram2-ce[2]
...
#set_property -dict { PACKAGE_PIN AB25  IOSTANDARD LVCMOS33 } [get_ports { sram2_oe[1] }]; #IO_L6N_T0_VREF_13 Sch=sram2-oe[1]
#set_property -dict { PACKAGE_PIN U30   IOSTANDARD LVCMOS33 } [get_ports { sram2_oe[2] }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=sram2-oe[2]
#set_property -dict { PACKAGE_PIN W23   IOSTANDARD LVCMOS33 } [get_ports { sram2_we[1] }]; #IO_L20P_T3_A08_D24_14 Sch=sram2-we[1]
#set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { sram2_we[2] }]; #IO_L4P_T0_D04_14 Sch=sram2-we[2]
...
## DDR3 Memory
## NOTE: DDR3 pin constraints do not need to be uncommented if the Digilent Board files and Xilinx MIG are used.
#set_property -dict { PACKAGE_PIN AK9   IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[0] }]; #IO_L15N_T2_DQS_33 Sch=ddr3_a[0]
#set_property -dict { PACKAGE_PIN Y10   IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[1] }]; #IO_L4N_T0_33 Sch=ddr3_a[1]
#set_property -dict { PACKAGE_PIN AG9   IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[10] }]; #IO_L16P_T2_33 Sch=ddr3_a[10]
#set_property -dict { PACKAGE_PIN AJ9   IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[11] }]; #IO_L15P_T2_DQS_33 Sch=ddr3_a[11]
#set_property -dict { PACKAGE_PIN AH9   IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[12] }]; #IO_L16N_T2_33 Sch=ddr3_a[12]
#set_property -dict { PACKAGE_PIN AB12  IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[13] }]; #IO_L1N_T0_33 Sch=ddr3_a[13]
#set_property -dict { PACKAGE_PIN AE11  IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[14] }]; #IO_L11P_T1_SRCC_33 Sch=ddr3_a[14]
#set_property -dict { PACKAGE_PIN AD9   IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[15] }]; #IO_L10P_T1_33 Sch=ddr3_a[15]
#set_property -dict { PACKAGE_PIN AA11  IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[2] }]; #IO_L5P_T0_33 Sch=ddr3_a[2]
#set_property -dict { PACKAGE_PIN AC11  IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[3] }]; #IO_L9N_T1_DQS_33 Sch=ddr3_a[3]
#set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[4] }]; #IO_L4P_T0_33 Sch=ddr3_a[4]
#set_property -dict { PACKAGE_PIN AH12  IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[5] }]; #IO_L24N_T3_33 Sch=ddr3_a[5]
#set_property -dict { PACKAGE_PIN AF11  IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[6] }]; #IO_L11N_T1_SRCC_33 Sch=ddr3_a[6]
#set_property -dict { PACKAGE_PIN AA12  IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[7] }]; #IO_L1P_T0_33 Sch=ddr3_a[7]
#set_property -dict { PACKAGE_PIN AG13  IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[8] }]; #IO_L24P_T3_33 Sch=ddr3_a[8]
#set_property -dict { PACKAGE_PIN AC12  IOSTANDARD LVCMOS15 } [get_ports { ddr3_a[9] }]; #IO_L9P_T1_DQS_33 Sch=ddr3_a[9]
#set_property -dict { PACKAGE_PIN AE9   IOSTANDARD LVCMOS15 } [get_ports { ddr3_ba[0] }]; #IO_L10N_T1_33 Sch=ddr3_ba[0]
#set_property -dict { PACKAGE_PIN AA10  IOSTANDARD LVCMOS15 } [get_ports { ddr3_ba[1] }]; #IO_L5N_T0_33 Sch=ddr3_ba[1]
#set_property -dict { PACKAGE_PIN AC10  IOSTANDARD LVCMOS15 } [get_ports { ddr3_ba[2] }]; #IO_L7N_T1_33 Sch=ddr3_ba[2]
#set_property -dict { PACKAGE_PIN AB8   IOSTANDARD LVCMOS15 } [get_ports { ddr3_casn }]; #IO_L2N_T0_33 Sch=ddr3_casn
#set_property -dict { PACKAGE_PIN AC9   IOSTANDARD LVDS     } [get_ports { ddr3_ck_n }]; #IO_L3N_T0_DQS_33 Sch=ddr3_ck_n
#set_property -dict { PACKAGE_PIN AB9   IOSTANDARD LVDS     } [get_ports { ddr3_ck_p }]; #IO_L3P_T0_DQS_33 Sch=ddr3_ck_p
#set_property -dict { PACKAGE_PIN AE8   IOSTANDARD LVCMOS15 } [get_ports { ddr3_cke }]; #IO_L8N_T1_33 Sch=ddr3_cke
#set_property -dict { PACKAGE_PIN AG10  IOSTANDARD LVCMOS15 } [get_ports { ddr3_csn }]; #IO_L13P_T2_MRCC_33 Sch=ddr3_csn
#set_property -dict { PACKAGE_PIN AD4   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dm[0] }]; #IO_L1P_T0_34 Sch=ddr3_dm[0]
#set_property -dict { PACKAGE_PIN AF6   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dm[1] }]; #IO_L12P_T1_MRCC_34 Sch=ddr3_dm[1]
#set_property -dict { PACKAGE_PIN AJ4   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dm[2] }]; #IO_L13N_T2_MRCC_34 Sch=ddr3_dm[2]
#set_property -dict { PACKAGE_PIN AF8   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dm[3] }]; #IO_L19P_T3_34 Sch=ddr3_dm[3]
#set_property -dict { PACKAGE_PIN AC2   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[0] }]; #IO_L2P_T0_34 Sch=ddr3_dq[0]
#set_property -dict { PACKAGE_PIN AD3   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[1] }]; #IO_L1N_T0_34 Sch=ddr3_dq[1]
#set_property -dict { PACKAGE_PIN AF5   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[10] }]; #IO_L11N_T1_SRCC_34 Sch=ddr3_dq[10]
#set_property -dict { PACKAGE_PIN AE4   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[11] }]; #IO_L10P_T1_34 Sch=ddr3_dq[11]
#set_property -dict { PACKAGE_PIN AF2   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[12] }]; #IO_L7N_T1_34 Sch=ddr3_dq[12]
#set_property -dict { PACKAGE_PIN AE5   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[13] }]; #IO_L11P_T1_SRCC_34 Sch=ddr3_dq[13]
#set_property -dict { PACKAGE_PIN AF3   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[14] }]; #IO_L7P_T1_34 Sch=ddr3_dq[14]
#set_property -dict { PACKAGE_PIN AE3   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[15] }]; #IO_L10N_T1_34 Sch=ddr3_dq[15]
#set_property -dict { PACKAGE_PIN AK1   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[16] }]; #IO_L17N_T2_34 Sch=ddr3_dq[16]
#set_property -dict { PACKAGE_PIN AH4   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[17] }]; #IO_L13P_T2_MRCC_34 Sch=ddr3_dq[17]
#set_property -dict { PACKAGE_PIN AJ1   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[18] }]; #IO_L17P_T2_34 Sch=ddr3_dq[18]
#set_property -dict { PACKAGE_PIN AH5   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[19] }]; #IO_L14N_T2_SRCC_34 Sch=ddr3_dq[19]
#set_property -dict { PACKAGE_PIN AC1   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[2] }]; #IO_L2N_T0_34 Sch=ddr3_dq[2]
#set_property -dict { PACKAGE_PIN AJ2   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[20] }]; #IO_L16N_T2_34 Sch=ddr3_dq[20]
#set_property -dict { PACKAGE_PIN AH6   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[21] }]; #IO_L14P_T2_SRCC_34 Sch=ddr3_dq[21]
#set_property -dict { PACKAGE_PIN AH2   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[22] }]; #IO_L16P_T2_34 Sch=ddr3_dq[22]
#set_property -dict { PACKAGE_PIN AJ3   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[23] }]; #IO_L18P_T2_34 Sch=ddr3_dq[23]
#set_property -dict { PACKAGE_PIN AK8   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[24] }]; #IO_L23N_T3_34 Sch=ddr3_dq[24]
#set_property -dict { PACKAGE_PIN AK6   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[25] }]; #IO_L22N_T3_34 Sch=ddr3_dq[25]
#set_property -dict { PACKAGE_PIN AF7   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[26] }]; #IO_L20P_T3_34 Sch=ddr3_dq[26]
#set_property -dict { PACKAGE_PIN AJ6   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[27] }]; #IO_L22P_T3_34 Sch=ddr3_dq[27]
#set_property -dict { PACKAGE_PIN AJ8   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[28] }]; #IO_L23P_T3_34 Sch=ddr3_dq[28]
#set_property -dict { PACKAGE_PIN AK4   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[29] }]; #IO_L24N_T3_34 Sch=ddr3_dq[29]
#set_property -dict { PACKAGE_PIN AD6   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[3] }]; #IO_L5P_T0_34 Sch=ddr3_dq[3]
#set_property -dict { PACKAGE_PIN AG7   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[30] }]; #IO_L20N_T3_34 Sch=ddr3_dq[30]
#set_property -dict { PACKAGE_PIN AK5   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[31] }]; #IO_L24P_T3_34 Sch=ddr3_dq[31]
#set_property -dict { PACKAGE_PIN AC7   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[4] }]; #IO_L6P_T0_34 Sch=ddr3_dq[4]
#set_property -dict { PACKAGE_PIN AE6   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[5] }]; #IO_L5N_T0_34 Sch=ddr3_dq[5]
#set_property -dict { PACKAGE_PIN AC5   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[6] }]; #IO_L4P_T0_34 Sch=ddr3_dq[6]
#set_property -dict { PACKAGE_PIN AC4   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[7] }]; #IO_L4N_T0_34 Sch=ddr3_dq[7]
#set_property -dict { PACKAGE_PIN AF1   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[8] }]; #IO_L8N_T1_34 Sch=ddr3_dq[8]
#set_property -dict { PACKAGE_PIN AE1   IOSTANDARD LVCMOS15 } [get_ports { ddr3_dq[9] }]; #IO_L8P_T1_34 Sch=ddr3_dq[9]
#set_property -dict { PACKAGE_PIN AD1   IOSTANDARD LVDS     } [get_ports { ddr3_dqs_n[0] }]; #IO_L3N_T0_DQS_34 Sch=ddr3_dqs_n[0]
#set_property -dict { PACKAGE_PIN AD2   IOSTANDARD LVDS     } [get_ports { ddr3_dqs_p[0] }]; #IO_L3P_T0_DQS_34 Sch=ddr3_dqs_p[0]
#set_property -dict { PACKAGE_PIN AG3   IOSTANDARD LVDS     } [get_ports { ddr3_dqs_n[1] }]; #IO_L9N_T1_DQS_34 Sch=ddr3_dqs_n[1]
#set_property -dict { PACKAGE_PIN AG4   IOSTANDARD LVDS     } [get_ports { ddr3_dqs_p[1] }]; #IO_L9P_T1_DQS_34 Sch=ddr3_dqs_p[1]
#set_property -dict { PACKAGE_PIN AH1   IOSTANDARD LVDS     } [get_ports { ddr3_dqs_n[2] }]; #IO_L15N_T2_DQS_34 Sch=ddr3_dqs_n[2]
#set_property -dict { PACKAGE_PIN AG2   IOSTANDARD LVDS     } [get_ports { ddr3_dqs_p[2] }]; #IO_L15P_T2_DQS_34 Sch=ddr3_dqs_p[2]
#set_property -dict { PACKAGE_PIN AJ7   IOSTANDARD LVDS     } [get_ports { ddr3_dqs_n[3] }]; #IO_L21N_T3_DQS_34 Sch=ddr3_dqs_n[3]
#set_property -dict { PACKAGE_PIN AH7   IOSTANDARD LVDS     } [get_ports { ddr3_dqs_p[3] }]; #IO_L21P_T3_DQS_34 Sch=ddr3_dqs_p[3]
#set_property -dict { PACKAGE_PIN AD8   IOSTANDARD LVCMOS15 } [get_ports { ddr3_odt }]; #IO_L8P_T1_33 Sch=ddr3_odt
#set_property -dict { PACKAGE_PIN AA8   IOSTANDARD LVCMOS15 } [get_ports { ddr3_rasn }]; #IO_L2P_T0_33 Sch=ddr3_rasn
#set_property -dict { PACKAGE_PIN AA13  IOSTANDARD LVCMOS15 } [get_ports { ddr3_rstn }]; #IO_L6P_T0_33 Sch=ddr3_rstn
#set_property -dict { PACKAGE_PIN AB10  IOSTANDARD LVCMOS15 } [get_ports { ddr3_wen }]; #IO_L7P_T1_33 Sch=ddr3_wen
